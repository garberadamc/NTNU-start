...
## Change starting location to folder `03-efa`
```{r}

source("rep_functions.R")

change_here(glue("{project_location}/03-efa"))
...
m_basic_fit <- mplusModeler(m_basic, 
               dataout=here("efa_mplus", "basic_els.dat"),
               modelout=here("efa_mplus", "basic_els.inp"),
...
m_efa_1_fit <- mplusModeler(m_efa_1, 
               dataout=here("efa_mplus", "efa_els.dat"),
               modelout=here("efa_mplus", "efa_els.inp"),
               check=TRUE, run = TRUE, hashfilename = FALSE)
...
m.step1.fit <- mplusModeler(m.step1, 
               dataout=here("efa_mplus", "efa_reduced.dat"),
               modelout=here("efa_mplus", "efa_reduced.inp"),
               check=TRUE, run = TRUE, hashfilename = FALSE)
